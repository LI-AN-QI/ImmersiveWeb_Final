...
function animate() {
	...
	if (meshes.photo) {
		...
		meshes.photo.position.y = Math.sin(tick * 0.1) * -2.1 //Math.cos(tick * velocity)* radius
	}
	...
	if (meshes.guitar) {
		...
		meshes.guitar.position.x = Math.cos(tick * 0.1) * 2.5
		//meshes.guitar.position.z = Math.sin(tick * 0.1) * -2
		meshes.guitar.position.y = Math.cos(tick * -0.15) * 2.5 //Math.cos(tick * velocity)* radius
	}
	...
	if (meshes.flower) {
		...
		meshes.flower.position.x = Math.cos(tick * 0.1) * -1.2
